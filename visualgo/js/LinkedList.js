...
LinkList.prototype.initAttributes = function () {
  ...
  // this.objectIDHead = 2;
  this.width = 50; // 矩形的宽度
  this.height = 30; // 矩形的高度
  this.widthLength = 70; // 矩形的宽度
  this.heightLength = 50; // 矩形的高度
  this.interval = 120; // 间隙
  this.foregroundColor = "#000000"; // 前景色
  this.backgroundColor = "#fff"; // 背景色
  this.tomato = "#Coral"; // tomato色
  this.palegreen = "#32CD32"; // palegreen色
  this.startX = 450; // 新节点的x坐标
  this.startY = 200; // 新节点的y坐标
  this.startHeadY = 330; // 头结点的y坐标
  this.startheadArrowY = 250; // 头指针的y坐标
  this.starttailArrowY = 310; // 尾指针的y坐标
  this.startNewNodex = 600;
  this.startNewNodey = 400;
  // this.arrowLengthx = 50; // 箭头的长度
  this.arrowLength = 30;
  this.radius = 20;
...
LinkList.prototype.initHeadNode = function () {
  ...
  // 绘制头结点
  {
    this.cmd(
      "SetState",
      "Create the head pointer of the linked list. The linked list is a singly linked list with a head. You can insert elements starting from 1"
    );
    this.cmd(
      "CreateRectangle",
      this.head.objectID,
